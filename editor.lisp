    ...
    (let** ((frame (set-style (create-element "div")
            ...
            (#'clipboard-cut (event)
              ...
              (try
                (progn
                  ...
                  (delete-selection))
                (baloon "Your browser doesn't support clipboard"))
              (fix))
            (#'clipboard-copy (event)
              ...
              (try
                (progn
                  (event.clipboardData.setData "text/plain" (selection))
                  (baloon ~"{(length (selection))} chars copied"))
                (baloon "Your browser doesn't support clipboard"))
              (fix))
      ...
      (set-style hinput
                 ...
                 px/padding 0
                 px/margin 0)
      (setf hinput.oncut #'clipboard-cut)
      (setf hinput.oncopy #'clipboard-copy)
      (setf hinput.onpaste #'clipboard-paste)
